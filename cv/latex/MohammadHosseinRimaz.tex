...
{\renewcommand{\arraystretch}{1.2}
\begin{tabular}{l l}
Summer 2017 & \textbf{Autonomous landing on Artificial Landmark} \\ & Role: Developer in KN2C Robotic Lab: Aerial Unmanned Vehicle Team \\&Design an artificial landmark and develop a real-time vision based \\& autonomous landing algorithm in both outdoor and indoor using OpenCV and C++.
\\
\\
...
Several mathematical visualizations, which implemented in JavaFX.\\& These project uses as a resource for students of the “Differential Equation” and\\& “Advanced Engineering Mathematics” course in K. N. Toosi University of Technology.
